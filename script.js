document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getFieldError(field) {
      ...
      if (type === 'email' && value.trim() !== '' && !VALIDATORS.email(value)) {
      ...
      if (field.hasAttribute('minlength') && value.trim() !== '') {
  ...
  (function initRTL() {
    ...
    if (isRTL) {
      ...
      const rtlAnimatables = document.querySelectorAll('.fade-in-left, .fade-in-right');
      rtlAnimatables.forEach(function (el) {
        if (el.classList.contains('fade-in-left')) {
          el.classList.remove('fade-in-left');
          el.classList.add('fade-in-right', 'rtl-flipped');
        } else if (el.classList.contains('fade-in-right') && !el.classList.contains('rtl-flipped')) {
          el.classList.remove('fade-in-right');
          el.classList.add('fade-in-left', 'rtl-flipped');
        }
      });
    }
  })();
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "משה נעליים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd948a743-98dc-4191-a7b1-81b0f0dbd93c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd948a743-98dc-4191-a7b1-81b0f0dbd93c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd948a743-98dc-4191-a7b1-81b0f0dbd93c';
